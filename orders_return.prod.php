...
fopen('/var/www/domains/sportsmanssupplyinc.com/jetpartner/htdocs/return/jetreturn.csv', 'w');
header("Refresh:2; url=returns.php");
        }else{
        echo "Creating Returns File.... ";
        header("Refresh:2; url=returns2.php");
copy("/var/www/domains/sportsmanssupplyinc.com/jetpartner/htdocs/return/jetreturn.csv", "/var/www/domains/sportsmanssupplyinc.com/jetpartner/htdocs/archives/return/jetreturn-$filedate.csv");
unlink("/var/www/domains/sportsmanssupplyinc.com/jetpartner/htdocs/return/jetreturn.csv"); 
      $fp = fopen('/var/www/domains/sportsmanssupplyinc.com/jetpartner/htdocs/return/jetreturn.csv', 'w');
