...
$csv = csv_to_array($filename='JetGDSTL.csv', $delimiter=',');
$cnt=0;
...
$request = array('product_title'=> $product_title,
    ...
    'shipping_weight_pounds'=> intval($weight),
    'package_length_inches'=> intval($dlength),
    'package_width_inches'=> intval($dwidth),
    'package_height_inches'=> intval($dheight),
    'prop_65'=> TRUE,
