...
//echo "<br>";
        ...
        if (($handle = fopen("/var/www/domains/sportsmanssupplyinc.com/jetpartner/htdocs/return/jetreturn.csv", "r")) !== FALSE){ 
...
<!-- Jet depreciated this endpoint - removed this on 6/14/16

<u><h2>Acknowledge Returns</h2></u><br>
<form action="orders_return_acknowledge.prod.php" method="post">
...
<form action="orders_return_complete.prod.php" method="post">
<strong>Merch Auth ID: </strong><input type="text" id="boxsize" placeholder = "merchant_return_authorization_id" name="id">  <br>
...
<div align = "right">
          <a href = "mailto:mzschiegner@ssisports.net?subject=Jet Order Returns Feedback">Feedback?</a>
        </div>
